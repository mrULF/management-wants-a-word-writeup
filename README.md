...
Kategori: Digital Forensics Zorluk: Orta Platform: TryHackMe — Hacker Holidays 2026
...
DB Browser for SQLite ile Login Data içindeki tablolar
...
cryptsetup ile VeraCrypt konteynerini açma
...
KAPE triage dosyaları
   ...
   → 🚩 THM{1t_w4s_V3r4_A11_A1Ong?!}
Öğrenilen Dersler
Windows autologon şifreleri (DefaultPassword LSA secret) genelde düz metin olarak saklanır ve hash kırmaya gerek bırakmadan doğrudan kullanılabilir.
Chrome şifreleri Windows'ta DPAPI + kullanıcı parolası zinciriyle korunur; kullanıcı parolası ele geçirilirse tüm kayıtlı şifreler çözülebilir.
Dosya isimlendirme ve boyut kalıpları (uzantısız, yuvarlak boyut) şifreli konteynerlerin habercisi olabilir.
Bazen en zor görünen adım (parola kırma) hiç gerekmez — sistemde zaten düz metin olarak duran bir bilgi işi çözer.
